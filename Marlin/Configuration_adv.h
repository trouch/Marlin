...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  16      // = 0.04mm Babysteps are very small. Increase for faster motion.
 ...
 */
  ...
  #define MIN_PROBE_EDGE_LEFT   34
  #define MIN_PROBE_EDGE_RIGHT  34
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      450 // 650 stock Ender stepper
    #define E0_MICROSTEPS    16
