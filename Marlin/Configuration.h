...
#define STRING_CONFIG_H_AUTHOR "(trouch, Creawsome Core 2.0)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Creawsome Core"     // will be shown during bootup in line 1
...
// #define TOUCH_MI_PROBE
  ...
  #define TOUCH_MI_DEPLOY_XPOS X_MIN_POS        // For a magnet on the left side of the bed
  //#define TOUCH_MI_DEPLOY_XPOS X_MAX_POS        // For a magnet on the right side of the bed
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE-FRONT_PROBE_BED_POSITION)
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 X" STRINGIFY(Z_SAFE_HOMING_X_POINT) " Y" STRINGIFY(Y_BED_SIZE) " F6000"
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 117    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 117    // Y point for Z homing when homing all axes (G28).
#endif
